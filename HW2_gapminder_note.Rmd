...
Note: some R code isn't rendering for some reason, though it works on R studio's knit html, hum. 
...
`hist(data$lifeExp)` 
![lifeExp(data)](./images_gapminder/lifeExp_histo.jpeg)
...
![life expectancy versus GDP Per Capita](./images_gapminder/lifeExp_gdpPercap.jpeg)
...
![life expectancy versus population](./images_gapminder/lifeExp_pop.jpeg)
...
![Population versus GDP per Capita](./images_gapminder/pop_gdpPercap.jpeg)
